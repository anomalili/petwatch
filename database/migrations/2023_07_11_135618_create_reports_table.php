...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('reports', function (Blueprint $table) {
            ...
            $table->smallInteger('animalState')->nullable(); 
            // állat állapota 1 - eltűnt 2 - talált
            $table->smallInteger('reportState')->default(1); 
            // bejelentés állapota 1 - ellenörzés alatt, 2 - látható, 3 - törölt
            $table->foreignId('locationData')->nullable()->references('locationDataId')->on('Location_data');
